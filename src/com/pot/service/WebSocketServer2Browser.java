...
public class WebSocketServer2Browser extends WebSocketServer {
    
	public WebSocketServer2Browser(int port) {
        super(new InetSocketAddress(port));
    }

    public WebSocketServer2Browser(InetSocketAddress address) {
        super(address);
    }
